...
driver.save_screenshot("screenshots/mobile_01_customer_affairs_screenshot.png")
...
time.sleep(5)
driver.save_screenshot("screenshots/mobile_02_all_categories_screenshot.png")
financeCard__Expand = driver.find_element_by_partial_link_text("Take control of your finances")
financeCard__Expand.click()
time.sleep(5)
driver.save_screenshot("screenshots/mobile_03_finances_control_screenshot.png")
...
time.sleep(5)
driver.save_screenshot("screenshots/mobile_04_mortgages_screenshot.png")
...
time.sleep(5)
driver.save_screenshot("screenshots/mobile_05_calculator_screenshot.png")
...
driver.save_screenshot("screenshots/mobile_06_calculator_result_screenshot.png")
time.sleep(5)
driver.close()
